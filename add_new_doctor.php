    ...
    <header >
         <div class="header-top wow fadeIn" >
            <div class="container" dir="ltr">
                <a class="navbar-brand" href="index.html"  style="text-decoration-color: black;color: black;"><img src="images/fevicon.ico.png" height="40" width="40" alt="image"  style="text-decoration-color: black;color: black;"><i>Flower Hosbital</i></a>
            ...
            <div class="row">
               ...
               <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  <div class="appointment-form" dir="ltr">
                     <h3><span>+</span> create new doctor</h3>
                           ...
                           <fieldset>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 select-section">
                                 ...
                                 <div class="row">
                                      ...
                                      dr name:<input type="text" name="doctor_name" width="150" > </br>
    <!--  اسم الطبيببيب:<input type="text" class="form-control" name="doctor_name" id='name'  > </br> --> 
   <!-- <input type="text"  name="doctor_name" id="name"  /> -->
dr specialization:<select name="doctor_specialization" class="form-control"  >
    <?php
   ...
   degree :<select name="doctor_science_degree" class="form-control" >
...
<?php
    ...
    echo"<input type='checkbox' name='c[]' value='$y'  >$y"."<br>";
    echo"<span class='checkmark' ></span>";
    // echo"</label>";
              }

  // $days=array("السبت" ,"الاحد","الاثنين","الثلاثاء", "الاربعاء" , "الخميس" ,"الجمعه");
  // for ($i=0; $i <count($days); $i++) { 
  
    
  //  //echo "<input type='checkbox' name='c[]'>$days[$i]";
  //    }
 ...
 echo "from"."<select name='hour_from' class='form-control' >";
 ...
 echo "to "."<select name='hour_to' class='form-control' >";
...
<input type="file" name="fileToUpload" id="fileToUpload"><br>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <div class="row">
                                    <div class="form-group">
                                       <div class='center'>  <button type='submit' name='create'>add new doctor</button></div>
                                    </div>
                                 </div>
                              </div>
                           </fieldset>
...
// echo $h;
            ...
            $degree=$_POST['doctor_science_degree'];
        $days=$_POST['c'];
 ...
 if($name=="" ||$name==" ")
         {
            echo"this is an error ocure be sure to enter doctor name";
...
$start_time=date('d-m',$start_t);
  ...
  if ($days[$i]=='Saturday') {
      ...
      $days[$i]= date('Y-m-d',$start_t);
       ...
       $sql="INSERT INTO doctors VALUES('$y','$name','$specialization','$degree','Saturday','$days[$i]','$hour_from','$hour_to','')";
  ...
  if ($days[$i]=='Sunday') {
     ...
     $days[$i]= date('Y-m-d',$start_t);
      ...
      $sql="INSERT INTO doctors VALUES('$y','$name','$specialization','$degree','Sunday','$days[$i]','$hour_from','$hour_to','')";
      if($con->query($sql)==TRUE )
         {
  ...
  if ($days[$i]=='Monday') {
      ...
      $days[$i]= date('Y-m-d',$start_t);
       ...
       $sql="INSERT INTO doctors VALUES('$y','$name','$specialization','$degree','Monday','$days[$i]','$hour_from','$hour_to','')";
        if($con->query($sql)==TRUE )
         {
 ...
 if ($days[$i]=='Tuesday') {
      ...
      $days[$i]= date('Y-m-d',$start_t);
       ...
       $sql="INSERT INTO doctors VALUES('$y','$name','$specialization','$degree','Tuesday','$days[$i]','$hour_from','$hour_to','')";
        if($con->query($sql)==TRUE )
         {
  ...
  if ($days[$i]=='Wednesday') {
      ...
      $days[$i]=date('Y-m-d',$start_t);
       ...
       $sql="INSERT INTO doctors VALUES('$y','$name','$specialization','$degree','Wednesday','$days[$i]','$hour_from','$hour_to','$block')";
        if($con->query($sql)==TRUE )
         {
  ...
  if ($days[$i]=='Thursday') {
       ...
       $days[$i]= date('Y-m-d',$start_t);
        ...
        $sql="INSERT INTO doctors VALUES('$y','$name','$specialization','$degree','Thursday','$days[$i]','$hour_from','$hour_to','')";
         if($con->query($sql)==TRUE )
         {
  ...
  if ($days[$i]=='Friday') {
       ...
       {    
          ...
          # code...
           ...
           $sql="INSERT INTO doctors VALUES('$y','$name','$specialization','$degree','Friday','$days[$i]','$hour_from','$hour_to','')";      
            if($con->query($sql)==TRUE )
         {
