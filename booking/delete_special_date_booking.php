          ...
          <div id="navbar" class="navbar-collapse collapse" >
                    ...
                    <!--     <li><a data-scroll href="add_new_specialization.php">add new specialization</a></li> -->
                        ...
                        <li class="dropdown"><a data-scroll href="#">reports</a><div class="dropdown-content" class="dropbtn">
                                        ...
                                        <a href="all_booking_reports.php"> booking report</a>
                                       <a href="booking_report_under_condision.php"> booking report under condision</a>
                                       
                                      </div>
                                    </li>
                                     <li class="dropdown"><a data-scroll href="#">delete</a><div class="dropdown-content" class="dropbtn">
                                      <a href="../doctors/delete_all_doctor_need_dates.php">delete all doctor need dates</a>
                                      <a href="../doctors/delete_doctor.php">delete doctor</a>
                                        <a href="delete_all_booking.php">delete all booking</a>
                                        <a href="delete_special_date_booking.php">delete specail date booking</a>
            ...
            <div class="row">
               ...
               <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  <div class="appointment-form" dir="ltr">
                     <h3><span>+</span> delete patient special book</h3>
...
?>
        <select name="x" onchange="this.form.submit()" > 
         <option selected disabled>choose booking date</option>

     
            <?php
         $sql="SELECT bookdaydate FROM register where name='$patient'";
        $res = $con -> query($sql);
        while($row = $res -> fetch_assoc()){
          $bookingdate = $row['bookdaydate'];
          echo "<option>$bookingdate</option>";
          echo "<input type='hidden' name='name' value='$patient'>";
        }
  ...
  $patient=$_POST['name'];
      //$_SESSION['name']=$name;
        $sql = "SELECT * FROM register where name='$patient' and bookdaydate='$bookdaydate' ";
        ...
        $row = $res -> fetch_assoc();
         ...
         $name = $row["name"];
         //echo $name;
        $specialization = $row["drspecialization"];
         $degree = $row["drdegree"];
            $drname = $row["drname"];
        $dayname = $row["dayname"];
         $bookdaydate = $row["bookdaydate"];
        $age = $row["age"];
        $num = $row["num"];
        //echo $name;

           echo "name: <input name='name' value='$name' readonly ><br>";
         echo "name: <input name='num' value='$num' readonly ><br>";
          echo "name: <input name='drname' value='$drname' readonly ><br>";
          echo "name: <input name='age' value='$age' readonly ><br>";
         echo "name: <input name='specialization' value='$specialization' readonly ><br>";
          echo "name: <input name='degree' value='$degree' readonly ><br>";
            echo "name: <input name='dayname' value='$dayname' readonly ><br>";
          echo "name: <input name='bookdaydate' value='$bookdaydate' readonly ><br>";
 ...
 // $start=strtotime('now',time());
        // $start_time=date('d-m',$start_t);
         ...
         $sql = "DELETE  FROM register where name='$name' and bookdaydate='$bookdaydate' and drname='$drname'"; //Line 10
