            ...
            <div class="row">
               ...
               <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  <div class="appointment-form" dir="rtl">
                     <h3><span>+</span>block all past dates</h3>
                        ...
                        <form method="post" dir="rtl">
                           <fieldset>
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <div class="row">
                                    <div class="form-group">
                                       <div class='center'>  <button type='submit' name='block'>block</button></div>
                                    </div>
                                 </div>
                              </div>
                           </fieldset>
...
if (isset($_POST['block'])) {
  ...
  $daytime= date('Y-m-d',$start_t);
//   echo $daytime;
   $current=explode("-",$daytime);
  
 include '../database.php';
        $con=dbconnect();
  $sql = "SELECT day FROM doctors ";
...
// return "<pre>";
      ...
      //echo $date;
    if ($past[2]<$current[2] && $past[1]==$current[1] ) {
      $sql = "UPDATE doctors SET block='block' where day='$date'";
