            ...
            <div class="row">
               ...
               <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  <div class="appointment-form" dir="ltr">
                     <h3><span>+</span>make block for special doctor date</h3>
  ...
  if (isset($_POST['x'])) {
      $name=$_POST['x'];
       ...
       <?php
        ...
        // Line2
        $res = $con -> query($sql);
echo "<select name='data' onchange='this.form.submit()'>";
 echo "<option selected disaled>choose time</option>";
        while($row = $res -> fetch_assoc()){
          $name = $row['name']; //Line3
          $dayname = $row['dayname'];
          $day = $row['day'];
         
          echo "<option>".$day."..".$dayname."..".$name."</option>";
        }
       ?>
      ...
      if(isset($_POST["data"]))
      {
       ...
       $name=$dataday[2];
        ...
        $sql = "SELECT * FROM doctors where name='$name' and day='$day'";
        $res = $con -> query($sql);
          $row = $res -> fetch_assoc();
        ...
        $hour_to = $row["hour_to"];
      //  echo $name,$specialization,$hour_from;
$value="day"." ".$dayname." "."date"." "."from"." ".$hour_from."to"." ".$hour_to;
           echo "hour: <input name='name' value='$name'  style='font-weight:bold' readonly ><br>";
       
        echo "day: <input name='dayname' value='$value' style='font-weight:bold' readonly><br>";
        echo "date: <input name='day' value='$day' style='font-weight:bold' readonly><br>";
        echo "from: <input name='hour_from' value='$hour_from' readonly ><br>";
        echo "to: <input name='hour_to' value='$hour_to' readonly ><br>";
       echo "<input type='checkbox' name='block' value='block' >block";

    // echo"<label class='c' >";
    // echo"<input type='checkbox' name='block' value='block' class='l'  >block";
    // echo"<span class='checkmark' ></span>";
    // echo"</label>";
        //echo "<input type='submit' name='updat' value ='Update' ><br>";
      echo"<div class='form-group'>";
       echo "<div class='center'>";
       echo " <button type='submit' name='updat'>Block</button></div>";
         echo"  </div>";
    }
      ?>
      ...
      <br>
         ...
         if (isset($_POST['block'])) {
           $sql = "UPDATE doctors SET block='block' where day='$day' and name='$name' "; //Line 10
         ...
         else
         {
          echo "Error";
           ...
           $sql = "UPDATE doctors SET block=' ' where day='$day' and name='$name' "; //Line 10
