  ...
  display: block;
   ...
   <body class="clinic_version" >
            ...
            <div class="row">
               ...
               <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  <div class="appointment-form" dir="ltr">
                     <h3><span>+</span> update doctor data</h3>
      ...
      if(isset($_POST["x"]))
      {
        ...
        echo "new name: <input name='nam' >  <br>";
        echo "اspecialization: <select name='specialization' >";
        echo "<option >$specialization</option>";
         $sq="SELECT  name from specializations";
         $res = $con -> query($sq);
         while ( $row = $res -> fetch_assoc()) {
          $pecial= $row['name'];
          echo "<option>$pecial</option>";
          
         }
         echo"</select><br>";
         // $sqll="SELECT Distinct degree from doctors";
        echo "degree:<select name='degree' >";
  echo "<option >$degree</option>";
        echo "<option >Mr</option>";
        echo "<option >Advisor</option>";
        echo "<option >specialist</option>";

        echo"</select>"."<br>";
        // echo "يوم: <input name='dayname' value='$dayname' readonly ><br>";
        // echo "بتاريخ: <input name='day' value='$day' readonly><br>";
        // echo "من الساعه: <input name='hour_from' value='$hour_from'  readonly><br>";
        // echo "الى الساعه: <input name='hour_to' value='$hour_to' readonly><br>";
...
//echo $h;
        ...
        $sql = "UPDATE doctors SET photo='$y', name='$nam',specialization='$specialization' ,degree='$degree' where name='$nam'  ";//Line 10
 ...
 $sql = "UPDATE doctors SET photo='$y', name='$name',specialization='$specialization' ,degree='$degree' where name='$nam'  ";//Line 10
