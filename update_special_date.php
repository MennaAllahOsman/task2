   ...
   <body class="clinic_version" >
      ...
      <div id="service" class="services wow fadeIn">
            ...
            <div class="row">
               ...
               <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  <div class="appointment-form" dir="ltr">
                     <h3><span>+</span>update doctor dates</h3>
        ...
        <select name="x" onchange="this.form.submit()" > 
         <option selected disabled>choose drname</option> <!-- <!Line1> -->
         <?php
...
<select name='data' onchange='this.form.submit()'>
  <option selected disabled>choose the date to update</option>
       <?php
        ...
        while($row = $res -> fetch_assoc()){
          ...
          echo "<option>"."د/".".".$name.".".$day.".".$dayname."</option>";
        }
       ?>
 ...
 echo "</select>"."</br>";
        echo "date: <input name='day' value='$day' ><br>";
 ...
 // $start=strtotime('now',time());
        // $start_time=date('d-m',$start_t);
         ...
         $sql = "UPDATE doctors SET dayname='$dayname' ,day='$day' ,hour_from='$hour_from' ,hour_to='$hour_to' where name='$name' and day='$day'"; //Line 10
